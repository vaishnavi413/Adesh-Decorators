  ...
  return (
    <div className="view-container">
      <div className="no-print actions-bar" style={{ display: "flex", gap: "10px", justifyContent: "center", margin: "20px 0" }}>
        <button onClick={() => navigate("/")} className="back-btn" style={{ padding: "8px 20px", background: "#f8f9fa", color: "#000", fontWeight: "bold", border: "1px solid #ddd", cursor: "pointer" }}>⬅️ Back</button>
        <button onClick={downloadPDF} className="download-btn" style={{ padding: "8px 20px", background: "#000", color: "#fff", border: "none", cursor: "pointer", fontWeight: "bold" }}>⬇️ Download Invoice</button>
      </div>
      ...
      <div id="invoice-pdf" className="amazon-invoice">
        ...
        <div className="header-top" style={{ flexDirection: "column", alignItems: "center", textAlign: "center", marginBottom: "15px" }}>
